...
@Entity
@Table(name="listino_simulazione_voce_percentuale")
public class ListinoSimulazioneVocePercentuale implements Serializable {
	...
	public String getTableDefinition() {
		String tableDefinition = "CREATE TABLE IF NOT EXISTS listino_simulazione_voce_percentuale ("
	...
	public String toString() {
		return "ListinoSimulazioneVocePercentuale [id=" + id + ", valore=" + valore + ", minimo=" + minimo + ", massimo=" + massimo + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ListinoSimulazioneVocePercentuale other = (ListinoSimulazioneVocePercentuale) obj;
		if (id != other.id)
			return false;
		return true;
	}
