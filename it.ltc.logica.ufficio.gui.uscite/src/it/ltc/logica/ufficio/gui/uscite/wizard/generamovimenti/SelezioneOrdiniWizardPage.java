...
public class SelezioneOrdiniWizardPage extends PaginaWizard {
	...
	private final static String description = "Seleziona gli ordini per cui generare i movimenti d'uscita.";
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		tabella = new TabellaOrdiniDaLavorare(container, commessa, TipoOrdiniLavorabili.GENERARE);
