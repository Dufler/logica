...
public class AnalisiCDGPart {
		...
		btnCalcolaCDG.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (sede == null || inizio == null || fine == null) {
					...
					elaboraAnalisiControlloCDG(analisi);
				}
			}
		});
		...
		btnFiltra.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (analisiCommessa != null)
					elaboraAnalisiControlloCDGPerCommessa(analisiCommessa);
				else
	...
	private void elaboraAnalisiControlloCDG(List<AnalisiCommessa> analisi) {
		// Ripulisco tutto
		ripulisciComposite();
	...
	private void elaboraAnalisiControlloCDGPerCommessa(AnalisiCommessa analisiCommessa) {
		// Ripulisco tutto
		ripulisciComposite();
