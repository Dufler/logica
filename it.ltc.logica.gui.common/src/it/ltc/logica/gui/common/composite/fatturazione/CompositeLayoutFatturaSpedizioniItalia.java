...
public class CompositeLayoutFatturaSpedizioniItalia extends CompositeLayoutFattura {
	...
	public CompositeLayoutFatturaSpedizioniItalia(ParentValidationHandler parentValidator, Composite parent) {
		super(parentValidator, parent, subTitle);
