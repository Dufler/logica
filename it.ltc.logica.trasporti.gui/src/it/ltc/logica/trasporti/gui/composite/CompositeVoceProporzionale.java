...
public class CompositeVoceProporzionale extends Gruppo {
	...
	private ComboBox<StrategiaProporzionalePerTrasporti> comboTipo;
	...
	public void aggiungiElementiGrafici() {
		...
		comboTipo = new ComboBox<StrategiaProporzionalePerTrasporti>(this);
		comboTipo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		comboTipo.setItems(StrategiaProporzionalePerTrasporti.values());
	...
	public void setTipo(String tipo) {
		comboTipo.setSelectedValue(StrategiaProporzionalePerTrasporti.valueOf(tipo));
	}
