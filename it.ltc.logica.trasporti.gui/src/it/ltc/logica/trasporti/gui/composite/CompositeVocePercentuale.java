...
public class CompositeVocePercentuale extends Gruppo {
	...
	private ComboBox<StrategiaPercentualePerTrasporti> comboTipo;
	...
	public void aggiungiElementiGrafici() {
		...
		comboTipo = new ComboBox<StrategiaPercentualePerTrasporti>(this);
		comboTipo.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		comboTipo.setItems(StrategiaPercentualePerTrasporti.values());
	...
	public void setTipo(String tipo) {
		comboTipo.setSelectedValue(StrategiaPercentualePerTrasporti.valueOf(tipo));
	}
