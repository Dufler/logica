...
public class DialogSogliaContrassegno extends DialogSempliceConValidazione {
	
	private static final String title = "Inserisci Soglia Contrassegno";
	...
	public DialogSogliaContrassegno(String valorePrecedente) {
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		lblInserisciIlNumero.setText("Inserisci il valore di soglia del contrassegno: ");
