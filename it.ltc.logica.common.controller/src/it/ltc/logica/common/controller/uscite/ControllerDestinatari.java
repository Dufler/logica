...
/**
 * Un giorno questo controller sarà soppiantato dal controller indirizzi.
 * @author Damiano
 *
 */
public class ControllerDestinatari extends ControllerCommessa<Indirizzo> {
	
	public static final String title = "Destinatari";
	public static final String resource = "ordine/destinatario";

	public ControllerDestinatari(Commessa commessa) {
