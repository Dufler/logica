...
import it.ltc.logica.common.controller.fatturazione.documento.GiacenzeExcel;
...
public class ControllerDocumentiDiFatturazione {
	...
	public RealizzatoreDocumentoDiFatturazione getRealizzatore(AmbitoFattura modello) {
		RealizzatoreDocumentoDiFatturazione realizzatore;
		switch (modello.getId()) {
			case AmbitoFattura.ID_SPEDIZIONI : realizzatore = new TrasportiExcel(); break;
			case AmbitoFattura.ID_GIACENZE : realizzatore = new GiacenzeExcel(); break;
			default : throw new RuntimeException("Non è ancora stato definito un realizzatore di documenti per l'ambito " + modello.getNome());
		}
		return realizzatore;
