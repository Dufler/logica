...
public class DialogCliente extends DialogModel<Cliente> {
	...
	public boolean updateModel() {
		...
		boolean updateIndirizzo = modificheIndirizzo ? controllerIndirizzi.aggiorna(indirizzo) : true;
	...
	public boolean insertModel() {
		controllerIndirizzi.inserisci(indirizzo);
		valore.setIndirizzo(indirizzo.getId());
	...
	public void aggiungiElementiGrafici(Composite container) {
		compositeCliente = new CompositeCliente(this, container);
