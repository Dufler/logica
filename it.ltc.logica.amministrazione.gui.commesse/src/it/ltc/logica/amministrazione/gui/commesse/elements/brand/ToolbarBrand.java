...
public class ToolbarBrand extends ToolbarCRUDConFiltro<TabellaBrand, Brand, CriteriFiltraggioBrand> {
	
	private ComboBox<Commessa> comboCommessa;

	public ToolbarBrand(Composite parent) {
		super(parent);
	}
	...
	@Override
	protected CriteriFiltraggioBrand getCriteriDiFiltraggio() {
		CriteriFiltraggioBrand criteri = new CriteriFiltraggioBrand(comboCommessa.getSelectedValue(), filterText.getText());
		return criteri;
	}
