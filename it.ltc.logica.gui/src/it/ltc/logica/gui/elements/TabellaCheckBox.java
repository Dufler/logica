...
public abstract class TabellaCheckBox<T> extends CheckboxTableViewer {
	...
	public TabellaCheckBox(Composite parent, int style, int preferredHeight) {
	...
	public TabellaCheckBox(Composite parent, int style) {
		this(parent, style, SWT.DEFAULT);
	}

	public TabellaCheckBox(Composite parent) {
		this(parent, STILE_SEMPLICE, SWT.DEFAULT);
	}
	...
	@SuppressWarnings("unchecked")
	public List<T> getElementiSelezionati() {
		Object[] selezione = getCheckedElements();
