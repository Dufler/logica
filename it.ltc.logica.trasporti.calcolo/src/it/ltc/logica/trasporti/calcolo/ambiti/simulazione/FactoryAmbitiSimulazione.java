...
public class FactoryAmbitiSimulazione extends FactoryAmbiti {
	...
	public IAmbitoTrasporto getAmbito(Integer id, String valore) {
		...
		switch (id) {
			...
			case NoloNazioniSpecificheSimulazione.ID : ambito = new NoloNazioniSpecificheSimulazione(ambitoTrasporto, valore); break;
			case VolumeSuperioreASimulazione.ID : ambito = new VolumeSuperioreASimulazione(ambitoTrasporto, valore); break;
