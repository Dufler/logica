...
public class GiacenzaSosta extends IAmbitoTrasportoConValore {
	...
	private Integer getDurataInGiorniSostaGiacenza(Giacenza giacenza) {
		//Mi hanno chiesto di calcolare la durata delle giacenze solo con la differenza in giorni interi
...
//		}
		Integer durataInGiorni = giacenza != null ? giacenza.calcolaDurata() : null; 
