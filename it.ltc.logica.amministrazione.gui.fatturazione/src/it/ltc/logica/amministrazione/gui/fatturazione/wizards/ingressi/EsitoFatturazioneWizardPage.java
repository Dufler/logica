...
public class EsitoFatturazioneWizardPage extends PaginaWizardRisultati {
	...
	private final FatturazioneIngressiController controllerFatturazione;
	...
	public EsitoFatturazioneWizardPage() {
		...
		controllerFatturazione = FatturazioneIngressiController.getInstance();
	...
	private class ProcessoCaricamentoDati extends Processo {
		...
		private static final String title = "Caricamento dati di fatturazione";
		...
		public void eseguiOperazioni() throws Exception {
			List<LogisticaModel> lista = controllerFatturazione.getIngressiFatturati();
			//Calcolo dei totali
			double totRicavi = 0;
			int totIngressi = 0;
