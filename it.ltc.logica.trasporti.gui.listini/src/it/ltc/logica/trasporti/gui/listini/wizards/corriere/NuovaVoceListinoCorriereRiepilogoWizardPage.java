...
public class NuovaVoceListinoCorriereRiepilogoWizardPage extends PaginaWizardRisultati {
	
	private static final String title = "Nuova Voce di listino corriere - Riepilogo";
	...
	public NuovaVoceListinoCorriereRiepilogoWizardPage(VoceDiListinoCorriere voce) {
	...
	public void mostraRisultato() {
		...
		switch (tipoAlgoritmo) {
			...
			case SCAGLIONI : 
			{
				List<VoceDiListinoCorriereScaglioni> vociScaglioni = voce.getScaglioni();
