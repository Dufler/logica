...
public class ProprietaVoceListinoCommessaProporzionale extends DialogModel<VoceDiListino> {
	...
	private static final String titolo = "Propriet\u00E0 - Voce di listino cliente proporzionale";
	...
	public ProprietaVoceListinoCommessaProporzionale(VoceDiListino voceDiListino, ETipoListino tipo, boolean permesso) {
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		compositeVoce = new CompositeVoceListino(this, container, tipo);
