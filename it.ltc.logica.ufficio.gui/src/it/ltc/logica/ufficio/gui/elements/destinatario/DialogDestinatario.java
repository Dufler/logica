...
public class DialogDestinatario extends DialogModel<Indirizzo> {
	
	public static final String title = "Destinatario";
	
	private CompositeIndirizzo compositeIndirizzo;
	
	private final ControllerDestinatari controller;

	public DialogDestinatario(Indirizzo value, Commessa commessa) {
		super(title, value);
		
		controller = new ControllerDestinatari(commessa);
	}
