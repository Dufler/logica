...
public class ToolbarProdotti extends ToolbarCRUDConFiltro<TabellaProdotti, Prodotto, CriteriFiltraggioProdotto> {

	private static final String HINT_FILTRO = "Filtra per sku, modello, barcode...";
	
	private ComboBox<Commessa> comboCommessa;
	
	public ToolbarProdotti(Composite parent) {
		super(parent);
	}
	...
	@Override
	protected CriteriFiltraggioProdotto getCriteriDiFiltraggio() {
		CriteriFiltraggioProdotto filtro = new CriteriFiltraggioProdotto(comboCommessa.getSelectedValue(), filterText.getText());
		return filtro;
	}
