...
public class PreventivoSpedizioniImportateSelezioneSpedizioniWizardPage extends PaginaWizardRisultati {
	...
	private TabellaCheckBoxSpedizioneSimulazione checkboxTableViewer;
	private Table table;
	
	private boolean canFlip;

	public PreventivoSpedizioniImportateSelezioneSpedizioniWizardPage() {
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		checkboxTableViewer = new TabellaCheckBoxSpedizioneSimulazione(container, TabellaCheckBoxSpedizione.TIPO_COMPLETO);
	...
	public void mostraRisultato() {
		...
		Integer idDocumento = controllerPreventivo.getIdDocumento();
		...
		criteri.setIdDocumento(idDocumento);
		...
		checkboxTableViewer.setInput(controllerSpedizioni.selezionaSpedizioniSimulazione(criteri));
