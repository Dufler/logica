...
public class PreventivoSpedizioneFittiziaDatiWizardPage extends PaginaWizard {
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		Label lblColliDa = new Label(compositeDati, SWT.NONE);
		lblColliDa.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblColliDa.setText("Da quanti colli: ");
		
		textColliDa = new TextForInteger(compositeDati);
		textColliDa.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		addChild(textColliDa);
		
		new SpacerLabel(compositeDati);
		
		Label lblColliA = new Label(compositeDati, SWT.NONE);
		lblColliA.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 1));
		lblColliA.setText("A quanti colli: ");
		
		textColliA = new TextForInteger(compositeDati);
		textColliA.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
		addChild(textColliA);
		...
		tabellaIndirizzi = new TabellaCheckboxIndirizzi(compositeIndirizzi, TabellaCheckboxIndirizzi.STILE_SELEZIONE_SINGOLA);
	...
	protected boolean validazioneSpecifica(boolean valid) {
		boolean valido = valid && tabellaIndirizzi.getCheckedElements().length > 0 && textColliDa.getValue() < textColliA.getValue(); 
		return valido;
	}
	...
	public void copyDataToModel() {
		...
		controllerPreventivo.setColliDa(textColliDa.getValue());
		controllerPreventivo.setColliA(textColliA.getValue());
		boolean contrassegno = btnSi.getSelection();
