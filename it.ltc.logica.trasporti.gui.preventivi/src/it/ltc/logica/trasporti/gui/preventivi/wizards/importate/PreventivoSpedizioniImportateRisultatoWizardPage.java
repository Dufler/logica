...
public class PreventivoSpedizioniImportateRisultatoWizardPage extends PaginaWizardRisultati {
	
	private static final String titolo = "Preventivo di costo e fatturazione per una spedizione di simulazione.";
	...
	public PreventivoSpedizioniImportateRisultatoWizardPage() {
