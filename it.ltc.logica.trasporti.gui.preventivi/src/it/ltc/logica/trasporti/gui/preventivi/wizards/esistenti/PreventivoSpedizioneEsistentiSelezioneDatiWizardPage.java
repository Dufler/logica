...
public class PreventivoSpedizioneEsistentiSelezioneDatiWizardPage extends PaginaWizard {
	...
	private void aggiornaTabellaClienti(Commessa commessa) {
		ListinoCommessa listino = controllerListiniClienti.getListinoPerAmbitoECliente(AmbitoFattura.ID_SPEDIZIONI, commessa.getId());
		List<ListinoCommessa> listaConAlMassimoUnElemento = new LinkedList<>();
		if (listino != null)
			listaConAlMassimoUnElemento.add(listino);
		checkboxTableViewerClienti.setInput(listaConAlMassimoUnElemento);
	...
	public void aggiungiElementiGrafici(Composite container) {
		...
		comboViewer.setInput(ControllerCommesse.getInstance().getTutteCommesse());
