...
public class CompositeVoceScaglioni extends Gruppo {
	...
	private ComboBox<StrategiaScaglioniPerAmministrazione> comboTipo;
	...
	public void aggiungiElementiGrafici() {
		...
		comboTipo = new ComboBox<StrategiaScaglioniPerAmministrazione>(this);
		...
		comboTipo.setItems(StrategiaScaglioniPerAmministrazione.values());
		...
		btnInserisci.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				StrategiaScaglioniPerAmministrazione tipo = comboTipo.getSelectedValue();
	...
	private void setTipoScaglioni() {
		...
		if (abilita) {
			StrategiaScaglioniPerAmministrazione as = comboTipo.getSelectedValue();
	...
	public void setTipo(String tipo) {
		StrategiaScaglioniPerAmministrazione algoritmo = StrategiaScaglioniPerAmministrazione.valueOf(tipo);
